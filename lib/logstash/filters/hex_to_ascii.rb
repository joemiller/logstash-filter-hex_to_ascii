...
#
# Example audit message generated by pam_tty_audit.so:
#
#   type=TTY ... comm="bash" data=6364202F6F70742F746974616E0D
#
# This plugin will convert the above message into the more useful representation:
#
#   type=TTY ... comm="bash" data=cd /opt/titan
#
